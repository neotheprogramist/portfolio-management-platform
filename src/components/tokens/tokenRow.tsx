  ...
  return (
    <>
      <tr class="text-sm">
        ...
        <td class="">
          <span class="rounded-lg border border-white border-opacity-20 bg-white bg-opacity-10 px-2 py-1 text-white ">
            481
          </span>
        </td>
        <td class="">
        ...
        <td class="text-center">
          <span class="rounded-lg border border-green-500 border-opacity-20 bg-green-500 bg-opacity-10 px-2 py-1 text-green-500">
            +3,36%
          </span>
        </td>
        <td class="">
