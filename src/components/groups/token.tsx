    ...
    <>
      ...
      >
        ...
        <button class="rounded-[2px] bg-[#22222214] bg-opacity-[8]">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" onClick$={props.onClick$}>
            <rect width="20" height="20" rx="2" fill="#222222" fill-opacity="0.08"/>
