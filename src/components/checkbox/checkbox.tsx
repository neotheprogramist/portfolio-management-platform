...
export const CheckBox = component$<CheckBoxProps>((props) => {
  ...
  <div>
    ...
    class="relative">
      ...
      id="checkBox"
      type="text" 
      class="absolute custom-border-1 bg-transparent end-1.5 top-1.5 h-9 w-[375px] appearance-none rounded z-10 placeholder:text-white "
      />
      <label for="checkBox"
      class="absolute custom-bg-white w-full custom-border-1 inline-flex min-h-12 cursor-pointer items-center space-x-2 rounded-lg"
      >
        <span class="absolute start-2 flex gap-2">
          <div class="p-1 custom-border-1 rounded-lg mr-2">
            {props.image && <img src={props.image} width="24" height="24" />}
          </div>
          <div class="">
            <p>{props.text}</p>
