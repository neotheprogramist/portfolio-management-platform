...
export const PortfolioValue = component$<PortfolioValueProps>(
  ({ totalPortfolioValue }) => {
    return (
      <div class="custom-border-1 custom-bg-white col-start-1 col-end-3 row-span-1 row-start-1 grid grid-rows-[52px_32px_1fr] gap-[16px] overflow-auto rounded-[16px] p-[24px] custom-shadow">

        <div class="flex items-center justify-between custom-border-b-1 pb-[16px]">
          <h1 class="text-[20px] font-semibold">Portfolio Value</h1>
          <div class="text-right">
            <h1 class="bg-gradient-to-r from-red-600 via-orange-400 to-pink-500 bg-clip-text text-[20px] font-semibold text-transparent pb-[8px]">
              ${totalPortfolioValue}
            </h1>
            <p class="text-[12px]">
        ...
        <div class="flex items-center justify-between gap-[8px] text-[12px]">
          <div class="flex items-center gap-2">
            <h2 class="uppercase custom-text-50">Value over time</h2>
            <div class="custom-bg-white custom-border-1 flex h-[32px] gap-[8px] rounded-[8px] p-[3.5px]">
              ...
              <button class="px-[8px] rounded-[8px]">1W</button>
              <button class="px-[8px] rounded-[8px]">1M</button>
              <button class="px-[8px] rounded-[8px]">1Y</button>
            </div>
          </div>

          <div class="flex items-center gap-[8px]">
            <h2 class="uppercase custom-text-50 lg:hidden">Portfolio</h2>
