  ...
  ({ variant = "info", message = "", isVisible, id }: MessageProps) => {
    ...
    return (
      <>
        ...
        >
          <div
            class={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full  border ${variant === "success" ? "border-customGreen" : variant === "error" ? "border-[#F16360]" : "border-[#1AB1F5]"}`}
          >
            i
          </div>
