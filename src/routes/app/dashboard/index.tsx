    ...
    <div class="grid grid-rows-[max(330px)_auto] gap-6 p-10">
      <div class="grid grid-cols-[2fr_1fr_1fr] gap-6">
        ...
        <div class="custom-border-1 custom-shadow grid min-w-max grid-rows-[32px_1fr] gap-4 rounded-2xl p-6">
          <div class="flex items-center justify-between gap-2">
            ...
            <button class="custom-border-opacity-30 rounded-10 px-4 h-8 text-xs font-medium duration-300 ease-in-out hover:scale-110">
              See All
            </button>
          </div>
          <div class="">
      ...
      <div class="custom-border-1 grid grid-rows-[32px_1fr] gap-6 rounded-2xl p-6">
        <div class="flex items-center justify-between">
          ...
          <button
            class="custom-border-opacity-30 rounded-10 px-4 h-8 text-xs font-medium duration-300 ease-in-out hover:scale-110"
            onClick$={() => {
              nav("/app/portfolio");
            }}
          >
