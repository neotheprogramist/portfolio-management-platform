...
export const SuccessStatus = component$(() => {
  return (
    <>
      <div class="custom-bg-white flex h-7 items-center gap-1 rounded-lg border border-customGreen p-2">
        <IconSuccess />
...
export const WarningStatus = component$(() => {
  return (
    <>
      <div class="custom-bg-white flex h-7 items-center gap-1 rounded-lg border border-customWarning p-2">
        <IconWarning />
